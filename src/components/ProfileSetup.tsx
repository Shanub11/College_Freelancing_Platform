                ...
                <div>
                  <div className="flex items-center mb-6">
                    <button
                      type="button"
                      onClick={() => setStep(1)}
                      className="p-2 -ml-2 text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors rounded-full hover:bg-gray-100 dark:hover:bg-dark-surface-2 flex items-center justify-center"
                      aria-label="Go back"
                    >
                  ...
                  {userType === "freelancer" ? (
                    <div className="inline-flex items-center gap-2 badge-primary !px-4 !py-2 mb-6 font-medium">
                      <GraduationCap className="w-4 h-4" /> Setting up as Student Freelancer
                    </div>
                  ) : (
                    <div className="inline-flex items-center gap-2 badge !bg-emerald-50 dark:!bg-emerald-900/30 !text-emerald-700 dark:!text-emerald-400 !border-emerald-200 dark:!border-emerald-800 !px-4 !py-2 mb-6 font-medium">
                      <Briefcase className="w-4 h-4" /> Setting up as Client
                    </div>
                  )}
                </div>
